...
public class PointOverlay extends LabelMarker {
    ...
    public PointOverlay(LatLong geoPoint, Drawable drawable, MapPoint point) {
        this(geoPoint, drawable, point, -1);
    }

    public PointOverlay(LatLong geoPoint, Drawable drawable, MapPoint point, int id) {
     ...
     */
    public PointOverlay(int id, LatLong geoPoint, Drawable drawable) {
